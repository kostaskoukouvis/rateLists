            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form id="admin_form" class="form-horizontal" role="form" method="POST" action="/auth/register">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="phone"
                                           placeholder="+99999999999" value="{{ old('phone') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="password" class="form-control"
                                           placeholder="Choose a password (min: 6 characters)" name="password">
                                </div>
                            </div>
